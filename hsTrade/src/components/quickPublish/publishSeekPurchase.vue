<template>
    <div>
        <div class="publishSeekPurchase" v-if="!isShowSucc">
            <div class="release_name" v-if="editMode.status == 'publish'">发布求购信息</div>
            <div class="release_name" v-if="editMode.status == 'edit'">编辑求购信息</div>
                ...
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="商品分类" prop="goodsClassifis">
                        ...
                        <div class="goodsClassifis">
                            <ul class="">
                                <li>
                                    <el-select class="" v-model.trim="classifi.firstClassifi" @change="changeClassifi(classifi.firstClassifi, 1)" placeholder="选择分类（大分类）">
                    ...
                    <el-form-item label="采购数量" prop="storage">
                    ...
                    <el-form-item label="起订数量" prop="minCount" style="display:none">
                        <el-input v-model.trim="ruleForm.minCount" type="text" style="width:375px;"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;{{ruleForm.unit}}
                    </el-form-item>
                            ...
                            <ul class="">
                                <li>
                                    <el-select v-model="address.province" placeholder="请选择省" @change="changeProvince">
                                        <el-option :label="v" v-for="(v, k) in address.provinceList" :key="k" :value="k"></el-option>
                                    </el-select>
                                </li>
                                <li>
                                    <el-select v-model="address.city" placeholder="请选择市" @change="changeCity">
                                        <el-option :label="v" v-for="(v, k) in address.cityList" :key="k" :value="k"></el-option>
                                    </el-select>
                                </li>
                                <li>
                                    <el-select v-model="address.district" placeholder="请选择区">
                                        <el-option :label="v" v-for="(v, k) in address.districtList" :key="k" :value="k"></el-option>
                                    </el-select>
                                </li>
                            </ul>
                        </div>
                    ...
                    <el-form-item class="deliveryRequire" label="发货时间要求" prop="deliveryDays">支付尾款后&nbsp;&nbsp;
                        <!-- <el-input v-model="ruleForm.deliveryDays" style="width:300px;" placeholder="请输入发货时间" @blur="validateValue"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;工作日内 -->
                        <el-input v-model="ruleForm.deliveryDays" style="width:300px;" placeholder="请输入发货时间"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;工作日内
                    </el-form-item>
                    <!-- 含自定义发货时间 -->
                    <!-- <el-form-item class="deliveryRequire" label="发货时间要求" prop="deliveryDays">
                                            <span class="star">*</span> 支付尾款后&nbsp;&nbsp;
                                            <el-select v-model="deliveryTime" @focus="tips=''">
                                                <el-option label="当天发货" value="d1"></el-option>
                                                <el-option label="三个工作日内" value="d2"></el-option>
                                                <el-option label="七个工作日内" value="d3"></el-option>
                                                <el-option label="十个工作日内" value="d4"></el-option>
                                                <el-option label="十五个工作日内" value="d5"></el-option>
                                            </el-select>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <el-checkbox v-model="isCustomDeliveryTime" label="自定义" name="type"></el-checkbox>
                                            <span v-show="isCustomDeliveryTime">
                                            <el-input name="customDeliveryTime" v-model="customDeliveryTime" type="text" placeholder="自定义发货时间" style="width: 300px" @blur="validateValue"></el-input>
                                            &nbsp;&nbsp;日&nbsp;&nbsp;&nbsp;&nbsp;
                                            <span style="color: #999;">只可填入整数</span>
                                            </span>
                                            <div class="el-form-item__error" v-show="!!tips">{{tips}}</div>
                                        </el-form-item> -->
                    <el-form-item label="详细描述">
                        <!-- <el-input type="textarea" v-model.trim="ruleForm.shopDetail" :maxlength="50" :autosize="{ minRows: 6, maxRows: 8}" placeholder="请在这里输入" style="width:530px;">
                            </el-input> -->
                        <editor :options="editorOptions" style="width:750px;"></editor>
                        <!-- <p class="txt-right" style="width: 529px">{{ruleForm.shopDetail ? ruleForm.shopDetail.length : 0}}/50字</p> -->
                    </el-form-item>
                    <el-form-item>
                        <el-button class="queryBtn" type="primary" :disabled="isLogin&&this.$store.state.userData.userType != 1" @click="submitForm('ruleForm')">提交</el-button>
                    </el-form-item>
                </el-form>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            query() {
                this.editMode.shopId = this.$route.query.shopId;
                // this.editMode.itemDataIds = this.$route.query.itemDataIds;
                if (!!this.editMode.shopId) {
            ...
            shopModelList() {
                ...
                this.$ajax.post(modelInterface, {
                    ...
                    // this.classifi.firstClassifi = this.classifi.firstGoodsClassifis[0];
                })
            },
            getAddr() {
                            ...
                            // }
                                ...
                                if (!!this.classifi.thirdClassifi) {
                                        ...
                                        this.$ajax.post(interfaceName, this.ruleForm).then((res) => {
                                            this.sucInfos = res;
                                            this.sucInfos.type = 'SeekPurchase';
            ...
            validateValue(event) {
                this.tips = {};
                this.customDeliveryTime = this.customDeliveryTime.replace(/[\D\.]/gi, '');
            },
            continuePublish() {
